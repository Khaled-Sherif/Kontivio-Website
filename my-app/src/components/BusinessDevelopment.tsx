  ...
  return (
    <section className="k-guarantee" id="business-development">
      <div className="k-reveal" style={{ textAlign: 'center', maxWidth: 760, margin: '0 auto' }}>
        <div className="k-eyebrow" style={{ color: '#6ef5f5', display: 'flex', justifyContent: 'center' }}>Business Development</div>
        <h2 className="k-sec-h" style={{ color: 'white' }}>Strategic CX consulting<br />that drives growth.</h2>
        ...
        <Link to="/services/business-development"><button className="k-btn-hp">Learn More →</button></Link>
      </div>
    </section>
  );
};
