...
export const CTA: React.FC = () => {
  return (
    <section className="k-cta-sec">
      <h2>Ready to give your customers<br />the support they deserve?</h2>
      <p>Tell us about your business — we'll build a plan that fits.</p>
      <p className="k-cta-note">Limited onboarding spots available to ensure quality for every client.</p>
