  ...
  return (
    <section className="k-hero">
      <div className="k-hero-left">
        ...
        <h1>
          Your Customers<br />
          Deserve <span className="k-hl">World-Class</span><br />
          Support.
        </h1>
        ...
        <div className="k-hero-btns">
          <Link to="/contact"><button className="k-btn-hp">Get a Custom Quote →</button></Link>
          <a href="#how"><button className="k-btn-hs">How It Works</button></a>
        </div>
        <div className="k-hstats">
          <div className="k-hs"><div className="k-hs-n">&lt;60s</div><div className="k-hs-l">Response SLA</div></div>
          <div className="k-hs"><div className="k-hs-n">18+</div><div className="k-hs-l">Languages</div></div>
          <div className="k-hs"><div className="k-hs-n">24/7</div><div className="k-hs-l">Coverage</div></div>
          <div className="k-hs"><div className="k-hs-n">0</div><div className="k-hs-l">Lock-in</div></div>
        </div>
      </div>

      <div className="k-hero-right">
        <div className="k-fc k-fc1">
          <div className="k-fc-tag"><span className="k-live-d" />Live Operations</div>
        ...
        <svg viewBox="0 0 520 500" fill="none" xmlns="http://www.w3.org/2000/svg"
          ...
          <g filter="url(#gw)">
            <circle r="4" fill="#6ef5f5">
              <animateMotion dur="10s" repeatCount="indefinite"><mpath href="#op1" /></animateMotion>
            </circle>
          </g>
          <g filter="url(#gw)">
            <circle r="3" fill="#f0b429" opacity=".85">
              <animateMotion dur="14s" repeatCount="indefinite" keyPoints="1;0" keyTimes="0;1" calcMode="linear"><mpath href="#op2" /></animateMotion>
            </circle>
          </g>
