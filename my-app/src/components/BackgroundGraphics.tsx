  ...
  if (variant === 'glow') {
    return (
      <div aria-hidden="true" className={className} style={{
        ...
        background: 'radial-gradient(ellipse 58% 55% at 72% 46%, rgba(0,200,200,.18) 0%, transparent 68%), radial-gradient(ellipse 35% 38% at 16% 80%, rgba(0,200,200,.09) 0%, transparent 60%)',
      }} />
    );
  }
  return (
