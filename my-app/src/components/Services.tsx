...
const services = [
  ...
  },
  {
    ...
    icon: <><rect x="3" y="11" width="18" height="10" rx="2" /><circle cx="12" cy="5" r="2" /><line x1="12" y1="7" x2="12" y2="11" /><line x1="8" y1="15" x2="8" y2="17" /><line x1="16" y1="15" x2="16" y2="17" /></>,
  },
  {
    title: 'Analytics & QA',
    ...
    <section className="k-section k-services" id="services">
      <div className="k-row k-reveal">
        <div>
          ...
          <h2 className="k-sec-h">Every channel your<br />customers use — covered.</h2>
        </div>
        <p className="k-sec-sub">From live chat to multilingual voice, we handle the full spectrum so nothing slips through.</p>
      </div>
